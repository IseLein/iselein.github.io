...
**I am actively seeking an internship (to start May 2024).**
...
### Personal Projects
- [**Inventory**](https://github.com/IseLein/inventory), *written in Typescript, Next.js ([T3 stack](https://create.t3.gg/))*:
